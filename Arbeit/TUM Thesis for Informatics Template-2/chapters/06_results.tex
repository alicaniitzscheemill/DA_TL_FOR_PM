...
\begin{figure}[htp]
  ...
  \caption{Source and target accuracy: FULL MMD (left), FC MMD (right)}
...
\begin{figure}[H]
  ...
  \caption{MMD- and CE-Loss: FULL MMD (left), FC MMD (right)}
