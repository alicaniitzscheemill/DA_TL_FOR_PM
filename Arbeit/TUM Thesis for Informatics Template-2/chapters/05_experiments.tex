...
Fig. \ref{fig:samples_domain_class_dummy_influence_noise} visualizes how the perturbation of the frequencies and amplitudes and the noise added to each data point, generate differences between sequences of the same class and domain.
