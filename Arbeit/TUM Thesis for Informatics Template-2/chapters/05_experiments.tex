...
\begin{figure}[H]
  \centering
  \includegraphics[width=.42\textwidth]{samples_domain_class_dummy/Source_Domain_Class_0_obs_0.pdf}
  \hspace{.3cm}
  \includegraphics[width=.42\textwidth]{samples_domain_class_dummy/Source_Domain_Class_1_obs_0.pdf}

  \vspace{.3cm}

  \includegraphics[width=.42\textwidth]{samples_domain_class_dummy/Target_Domain_Class_0_obs_0.pdf}
  \hspace{.3cm}
  \includegraphics[width=.42\textwidth]{samples_domain_class_dummy/Target_Domain_Class_1_obs_0.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.42\textwidth]{samples_domain_class_dummy_influence_noise/Source_Domain_Class_0_obs_0.pdf}
  \hspace{.3cm}
  \includegraphics[width=.42\textwidth]{samples_domain_class_dummy_influence_noise/Source_Domain_Class_1_obs_0.pdf}

  \vspace{.3cm}

  \includegraphics[width=.42\textwidth]{samples_domain_class_dummy_influence_noise/Source_Domain_Class_0_obs_1.pdf}
  \hspace{.3cm}
  \includegraphics[width=.42\textwidth]{samples_domain_class_dummy_influence_noise/Source_Domain_Class_1_obs_1.pdf}
...
\subsection{Definition PHM Task on the Ball Screw Feed Drive Dataset}\label{ch:PHM_Task_Definition}
