...
def create_dataloader(data_path, list_of_BSD_states, window_size = 1024, overlap_size = 300, features_of_interest, dataloader_type, dataloader_split = 0.8, batch_size = 4):
    """
